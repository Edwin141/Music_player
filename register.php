...
<html>
<head>
	<title>Welcome to audioWave</title>
			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<div class="hasAccountText">
						<a href="#"><span id="hideLogin">Don't have an account ? Signup here</span> </a>
					</div>
				</form>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="username" name="username" type="text" placeholder="Your username" value="<?php getInputValue('username') ?>"required> <!-- value is there so that the form would remember the input -->
					</p>
					...
					<p>
						...
						<input id="email2" name="email2" type="text" placeholder="Your email" value="<?php getInputValue('email2') ?>" required>
					</p>
